...
;; Load paths to Nix-installed Emacs packages. The file is generated by
;; home-manager (see modules/common/emacs.nix) and lists derivation roots.
(load (expand-file-name "nix-emacs.el" user-emacs-directory) 'noerror)
